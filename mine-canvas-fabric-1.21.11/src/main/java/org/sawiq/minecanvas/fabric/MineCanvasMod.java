...
public final class MineCanvasMod implements ModInitializer {
    ...
    public void onInitialize() {
        // S2C - сервер -> клиент
        PayloadTypeRegistry.playS2C().register(MineCanvasS2CPayload.ID, MineCanvasS2CPayload.CODEC);
        // C2S - клиент -> сервер
        PayloadTypeRegistry.playC2S().register(MineCanvasC2SPayload.ID, MineCanvasC2SPayload.CODEC);
    }
}
