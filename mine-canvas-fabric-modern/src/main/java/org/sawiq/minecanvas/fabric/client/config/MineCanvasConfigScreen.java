...
public final class MineCanvasConfigScreen extends Screen {
    ...
    private void drawHeader(GuiGraphicsExtractor graphics) {
        ...
        graphics.text(font, title, titleX + 1, titleY + 1, 0x55382432, false);
        graphics.text(font, title, titleX, titleY, 0xFF4A3846, false);
    ...
    private void drawLandscape(GuiGraphicsExtractor graphics) {
